  ...
  as projection on ZATS_RP_TRAVEL
{
  ...
  key     TravelId,
          ...
          _Attachment : redirected to composition child ZATS_RP_ATTACH_PROCESSOR,
          _Currency,
          _Customer,
          _OverallStatus,

          //Virtal elements introduction - Only in Projection views


          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZCL_RP_ATS_VE_CALC'
